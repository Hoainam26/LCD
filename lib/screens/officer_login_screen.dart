  ...
  void _validateEmail() {
    setState(() {
      if (_emailController.text.isEmpty) {
        _emailError = true;
        _emailErrorMessage = 'Vui lòng nhập email cán bộ!';
  ...
  void _validatePassword() {
    setState(() {
      if (_passwordController.text.isEmpty) {
        _passwordError = true;
        _passwordErrorMessage = 'Vui lòng nhập mật khẩu cán bộ!';
